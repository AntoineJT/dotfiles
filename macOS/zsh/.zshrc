...
alias brew-refill="([ -f ~/.config/brew/Brewfile-base ] || (echo 'Missing base brewfile, aborting...' && exit 1)) && brew update && ocat ~/.config/brew/Brewfile-* | brew bundle install --file=- --cleanup && brew upgrade"
